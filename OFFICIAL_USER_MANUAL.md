...
- **Files:** You will receive a single file named `html_powerInsuranceApplication.html` along with the necessary CSV databases.

### 2.2 Launching the App
1. Locate the file `html_powerInsuranceApplication.html` on your computer.
2. Double-click the file to open it in your default web browser.
3. **Note:** Do not close the browser window while working. If you close it, you may need to re-import your data depending on your browser's settings (though data usually persists).
