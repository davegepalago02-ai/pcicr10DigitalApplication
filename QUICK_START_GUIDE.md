...
1.  Open `html_powerInsuranceApplication.html` in a text editor (Notepad, VS Code).
...
4. On phone: `http://[YOUR-IP]:8000/html_powerInsuranceApplication.html`
...
**Backup file available:** `html_powerInsuranceApplication_backup.html`
